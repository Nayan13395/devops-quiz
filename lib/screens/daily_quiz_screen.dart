...
class _DailyQuizScreenState extends State<DailyQuizScreen> {
  ...
  Future<void> loadQuiz() async {
    try {
      ...
      final List<Question> allQuestions = await QuestionService().loadQuestions(
        locale,
        'DailyQuiz',
      );
      ...
      if (allQuestions.isEmpty) {
        setState(() {
          loading = false;
          errorMessage = 'No Daily Quiz questions are available.';
        });
      ...
      final List<Question> dailyQuestions = allQuestions.take(25).toList();
      ...
      debugPrint('Daily Quiz loading error: $e');

      setState(() {
        loading = false;
        errorMessage = 'Unable to load Daily Quiz.';
      });
    }
  }
