...
class AppDrawer extends StatelessWidget {
  ...
  String _profileName() {
    ...
    final String name =
        UserProfileService.displayName.trim();
...
class _UserProfileAvatar
    extends StatefulWidget {
  const _UserProfileAvatar();

  @override
  State<_UserProfileAvatar> createState() =>
      _UserProfileAvatarState();
}

class _UserProfileAvatarState
    extends State<_UserProfileAvatar> {
  String? _photoUrl;
  ...
  Widget build(
    ...
    WebHtmlElementStrategy.fallback,
          ...
          errorBuilder: (
            ...
            debugPrint(
              'Google profile photo unavailable: $error',
            );
